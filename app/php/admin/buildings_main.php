<?php
    ...
    if (mysql_num_rows($query) > 0){
        ...
        while ($row = mysql_fetch_array($query)){
            echo '<div class="content_row"> <div class="content_cell_check"> <input type="checkbox" class="cell_checkbox"> </div> <div class="content_cell content_cell_1"> <input type="text" class="content_cell_input cci_1 search_input_digits" maxlength="2" readonly value=' . $row['NumberOfBuilding'] . ' data-val="' . $row['NumberOfBuilding'] . '"> </div> <div class="content_cell content_cell_2"> <input type="text" class="content_cell_input cci_2 search_input_digits" maxlength="2" readonly value=' . $row['QuantityOfFloors'] . '> </div> <div class="content_cell content_cell_btns"> <button class="content_cell_btn cell_edit"><i class="fa fa-pencil"></i></button> <button class="content_cell_btn cell_set"><i class="fa fa-check"></i></button> </div> </div>';
    	};
    	echo '</div>';
	} else {
		echo 0;
